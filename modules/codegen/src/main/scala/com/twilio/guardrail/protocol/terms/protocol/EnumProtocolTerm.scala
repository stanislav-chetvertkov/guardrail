...
case class ExtractEnum[L <: LA](swagger: StringSchema)                                        extends EnumProtocolTerm[L, Either[String, List[String]]]
case class ExtractType[L <: LA](swagger: StringSchema)                                        extends EnumProtocolTerm[L, Either[String, L#Type]]
